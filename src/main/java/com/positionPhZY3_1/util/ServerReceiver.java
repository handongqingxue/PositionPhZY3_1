...
public class ServerReceiver {
	...
	**/
	...
	public Map<String, Object> receiveMessage(HttpServletRequest request) {
		...
		//浏览器里查看推送情况的链接:http://localhost:15672/#/queues/%2F/tenant_msg_B962D6A9_sc21100449
        ...
        try {
        	...
        	if(IS_TEST) {//测试部分，在本地调用模拟接收推送消息
				...
				//channel.queueDeclare("tenant_msg_B962D6A9_sc21100449", true, false, false, null);
	
				// 5. 接收消息
				//tenant_msg_B962D6A9_sc21100449
